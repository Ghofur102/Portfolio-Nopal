...
<body>
    ...
    <div class="d-flex justify-content-center">
        <div class="lc-block col-md-4 col-md-offset-4" >
            ...
            @endif
            <form action="{{ route('update.experience', $experience->id) }}" enctype="multipart/form-data" method="post">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <input type="number" name="tahun_awal" placeholder="Tahun awal bekerja"
                        min="1900" max="2900" value="{{ $experience->tahun_awal }}"
                ...
                <div class="mb-3">
                    <input type="number" name="tahun_akhir"
                        placeholder="Tahun berakhir bekerja (kosongkan jika masih bekerja)" min="1900" value="{{ $experience->tahun_akhir }}"
                ...
                <div class="mb-3">
                    <input type="text" name="posisi_pekerjaan" placeholder="Posisi pekerjaan"
                        id="posisi_pekerjaan" value="{{ $experience->posisi_pekerjaan }}"
                ...
                <div class="mb-3">
                    <input type="text" name="nama_perusahaan" placeholder="Nama perusahaan"
                        id="nama_perusahaan" value="{{ $experience->nama_perusahaan }}"
                ...
                <div class="mb-3">
                    <textarea name="detail_pengalaman" id="detail_pengalaman" placeholder="Detail pengalaman"
                        class="form-control @error('detail_pengalaman') is-invalid @enderror" cols="30" rows="3">{{ $experience->detail_pengalaman }}</textarea>
